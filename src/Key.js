export default class Key {
    constructor({ key, code, shiftKey = null, size = null, isControlKey = false }, language, capsLock = false) {
        this.el = null;
        this.key = key;
        this.code = code;
    ...
    get label() {
        let label = (this.key.ru && this.key.en) ? this.key[this.language] : this.key;
        return (this.capsLock && !this.isControlKey) ? label.toUpperCase() : label;
    }
    get shiftKeyLabel() {
